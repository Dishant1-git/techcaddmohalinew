...
const paths: Record<string, React.ReactNode> = {
  ...
  refresh: (
    <>
      ...
      <path d="M3.5 4v4.5H8M20.5 20v-4.5H16" />
    </>
  ),
  verified: (
    <>
      <path d="m12 2.6 2.5 1.9 3.1-.2.9 3 2.5 1.9-1.2 2.9 1.2 2.9-2.5 1.9-.9 3-3.1-.2L12 21.4l-2.5-1.9-3.1.2-.9-3L3 14.8l1.2-2.9L3 9l2.5-1.9.9-3 3.1.2L12 2.6Z" />
