    ...
    >
      ...
      >
        {galleryTiles.map((tile, i) => (
          <div
            key={tile.id}
            className={`group relative overflow-hidden rounded-2xl bg-hero-950 ${tile.span} cursor-default transition-transform duration-300 ease-out will-change-transform hover:z-10 hover:scale-[1.06] hover:shadow-2xl hover:shadow-hero-950/30`}
          >
            <Image
              src={tile.src}
              alt={tile.alt}
